# encoding: utf-8
# module resource
# from /usr/lib64/python3.6/lib-dynload/resource.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe9cfdd4550>'

__spec__ = None # (!) real value is "ModuleSpec(name='resource', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe9cfdd4550>, origin='/usr/lib64/python3.6/lib-dynload/resource.cpython-36m-x86_64-linux-gnu.so')"
